"bag2vid.py" permet de passer d'un fichier .bag (format d'enregistrement du realsense D415) à des fichiers .avi. Il est important de noter que durant la conversion, l'information de distance est perdue.
